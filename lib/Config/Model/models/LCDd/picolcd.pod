...
balanced value.I<< Optional. Type uniline. default: '500'.  >>
...
Set the initial contrast [default: 1000; legal: 0 - 1000]I<< Optional. Type integer. upstream_default: '1000'.  >>

=head2 Keylights

Light the keys? i[default: on; legal: on, off]I<< Optional. Type enum. choice: 'on', 'off'. upstream_default: 'on'.  >>
...
which keys are disabled.  [default: on; legal: on, off]I<< Optional. Type enum. choice: 'on', 'off'. upstream_default: 'on'.  >>
...
UDP port on which LIRC is listening [default: 8765; legal: 1 - 65535]I<< Optional. Type integer. upstream_default: '8765'.  >>

=head2 LircFlushThreshold

Threshold in jiffies of synthesized gap that triggers flushing the IR data to lirc
[default: 100 (6.1ms); 0 to suppress]I<< Optional. Type uniline. upstream_default: '100'.  >>
