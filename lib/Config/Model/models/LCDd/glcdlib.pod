...
yes=use fonts supported by FreeType2 (needs Freetype2 support in libglcdprocdriver and its dependants)I<< Optional. Type uniline. default: 'yes'.  >>
...
minumum size in pixels in which fonts should be rendered. I<< Optional. Type uniline. default: '7x12'.  >>
