...
"no" if display connected serial, "yes" if connected parallel. I<< Optional. Type uniline. upstream_default: 'no(=serial)'.  >>
...
Set parallel port timingdelay (us). Used in parallelmode only. I<< Optional. Type integer. upstream_default: '2'.  >>
