...
[ match:"\/$" assert:"-d" ]I<< Optional. Type uniline. default: '/usr/lib/lcdproc/'.  >>
...
{ help 0:"no report" 1:"reports errors" 2:"reports warnings" 3:"reports info" }I<< Optional. Type integer. upstream_default: '2'.  >>

=head2 ReportToSyslog

Should we report to syslog instead of stderr ? [default: no; legal: yes, no]I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'no'.  >>
...
[ legal: yes, no ]I<< Optional. Type enum. choice: 'yes', 'no'. default: 'no'.  >>
...
is displayed. [default: on; legal: on, off, blank]I<< Optional. Type enum. choice: 'on', 'off', 'blank'. upstream_default: 'on'.  >>

=head2 Backlight

Set master backlight setting. If set to 'open' a client may control the
backlight for its own screens (only). [default: open; legal: off, open, on]I<< Optional. Type enum. choice: 'off', 'open', 'on'. upstream_default: 'open'.  >>

=head2 Heartbeat

Set master heartbeat setting. If set to 'open' a client may control the
heartbeat for its own screens (only). [default: open; legal: off, open, on]I<< Optional. Type enum. choice: 'off', 'open', 'on'. upstream_default: 'open'.  >>

=head2 TitleSpeed

set title scrolling speed [default: 10; legal: 0-10]I<< Optional. Type integer. upstream_default: '10'.  >>
