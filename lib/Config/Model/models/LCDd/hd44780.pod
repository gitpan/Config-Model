...
Port where the LPT is [ususal: 0x278, 0x378 and 0x3BC]I<< Optional. Type uniline. default: '0x378'.  >>

=head2 Device

Device of the serial interface [default: /dev/lcd]I<< Optional. Type uniline. default: '/dev/ttyS0'.  >>
...
Set the initial contrast (bwctusb and lcd2usb) [default: 500; legal: 0 - 1000]I<< Optional. Type integer. upstream_default: '500'.  >>

=head2 Brightness

Set brightness of the backlight (lcd2usb only) [default: 0; legal 0 - 1000]I<< Optional. Type uniline. upstream_default: '0'.  >>
...
underline effect. [default: true (= pixel addressable); legal: yes, no]I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'true'.  >>
...
the next line in DDRAM won't start 0x20 higher. [default: 0x20]I<< Optional. Type uniline. upstream_default: '0x20'.  >>

=head2 CharMap

Character map to to map ISO-8859-1 to the LCD's character set
[default: hd44780_default; legal: hd44780_default, hd44780_euro,
 ea_ks0073, sed1278f_0b, hd44780_koi8_r ]I<< Optional. Type uniline. default: 'hd44780_default'.  >>
