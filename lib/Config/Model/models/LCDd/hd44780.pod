...
Port where the LPT is I<< Optional. Type enum. choice: '0x278', '0x378', '0x3BC'.  >>
...
underline effect. I<< Optional. Type enum. choice: 'yes', 'no'. upstream_default: 'true(=pixeladdressable)'.  >>
...
Character map to to map ISO-8859-1 to the LCD's character set. I<< Optional. Type enum. choice: 'hd44780_default', 'hd44780_euro', 'ea_ks0073', 'sed1278f_0b', 'hd44780_koi8_r'. upstream_default: 'hd44780_default'.  >>
