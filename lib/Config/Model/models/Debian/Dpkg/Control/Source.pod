 ...
 * area/section if the package is in the contrib or non-free archive areas.I<< Optional. Type uniline.  >>
...
This field indicates the debian policy version number this package complies to. I<< Optional. Type uniline. default: '3.9.2'.  >>
