...
Specify meta parameters that will tune the behavior of this dpkg model. I<< Optional. Type node.  >>
...
compat file defines the debhelper compatibility level. I<< Optional. Type integer. default: '8'.  >>
