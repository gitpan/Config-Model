...
Specifies if the file system needs to be dumped Optional. Type boolean. default: '0'.

=head2 C<fs_passno>

used by the fsck(8) program to determine the order in which filesystem checks are done at reboot time Optional. Type integer. default: '0'.
