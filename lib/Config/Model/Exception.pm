...
{
  $Config::Model::Exception::VERSION = '1.258';
}
use warnings ;
use strict;
use Data::Dumper ;
...
{
  $Config::Model::Exception::Syntax::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::Any::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::LoadData::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::Model::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::Load::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::RestrictedElement::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::UnavailableElement::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::ObsoleteElement::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::UnknownElement::VERSION = '1.258';
}
use Carp;
...
{
  $Config::Model::Exception::UnknownId::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::WrongType::VERSION = '1.258';
}
...
{
  $Config::Model::Exception::Xml::VERSION = '1.258';
}
