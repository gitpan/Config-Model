...
BEGIN {
  $Config::Model::Exception::VERSION = '1.224';
}
use warnings ;
use strict;
use Data::Dumper ;
...
BEGIN {
  $Config::Model::Exception::Syntax::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::Any::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::LoadData::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::Model::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::Load::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::RestrictedElement::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::UnavailableElement::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::ObsoleteElement::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::UnknownElement::VERSION = '1.224';
}
use Carp;
...
BEGIN {
  $Config::Model::Exception::UnknownId::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::WrongType::VERSION = '1.224';
}
...
BEGIN {
  $Config::Model::Exception::Xml::VERSION = '1.224';
}
